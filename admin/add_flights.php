...
if($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST['submit'])){
 ...
 $stop= trim($_POST['stop']);
    ...
    $fare=trim($_POST['fare']);
           if(empty($error)){
               $insertQuery=$db->prepare("INSERT INTO flights (flightname,start,stop,departure,arrival,date,seats,fare) VALUES( ?,?,?,?,?,?,?,?);");
               $insertQuery->bind_param("ssssssss",$fname,$start,$stop,$dept,$arrival,$date,$seats,$fare);
...
<form method="post" class="mx-1 mx-md-4">
                  ...
                  <div class="d-flex flex-row align-items-center mb-2">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <label class="form-label" for="form3Example1c">Flight Name</label>
                    </div>
                  </div>
                  <div class="d-flex flex-row align-items-center mb-2">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input name="start" type="text" id="form3Example1c" class="form-control" required/>
                      <label class="form-label" for="form3Example1c">From</label>
                    </div>
                  </div>
                  <div class="d-flex flex-row align-items-center mb-2">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input name="stop" type="text" id="form3Example1c" class="form-control" required/>
                      <label class="form-label" for="form3Example1c">To</label>
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-2">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input name="dept" type="time" id="form3Example3c" class="form-control" required/>
                      <label class="form-label" for="form3Example3c">Departure</label>
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-2">
                    <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input name="arrival" type="time" id="form3Example3c" class="form-control" required />
                      <label class="form-label" for="form3Example3c">Arrival</label>
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-2">
                    <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input name="date" type="date" id="form3Example3c" class="form-control" required />
                      <label class="form-label" for="form3Example3c">Date</label>
                    </div>
                  </div>
                  ...
                  <div class="d-flex flex-row align-items-center mb-2">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input name="seats" type="text" id="form3Example4c" class="form-control" required/>
                      <label class="form-label" for="form3Example4c">Seats</label>
                    </div>
                  </div>
                  <div class="d-flex flex-row align-items-center mb-2">
                    <i class="fas fa-lock fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input name="fare" type="text" id="form3Example4c" class="form-control" required/>
                      <label class="form-label" for="form3Example4c">Price</label>
                    </div>
                  </div>

                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    <button type="submit" name="submit" class="btn btn-primary btn-lg">Add Flight</button>
                  </div>
                  </form>
    <style>
        *,
